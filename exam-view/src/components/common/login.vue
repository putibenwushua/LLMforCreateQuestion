...
<template>
  <div id="login">
          ...
          <div class="container">
            ...
            <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
              <el-form-item label="用户名">
                <el-input v-model.number="formLabelAlign.username" placeholder=""></el-input>
              </el-form-item>
              <el-form-item label="密码">
                <el-input v-model="formLabelAlign.password" placeholder="" type='password'></el-input>
              </el-form-item>
              <div class="submit">
    ...
    <el-row class="footer">
      <el-col>
        <!-- <p class="msg2" style="color: black;"></p> -->
      </el-col>
    </el-row>
  </div>
</template>
