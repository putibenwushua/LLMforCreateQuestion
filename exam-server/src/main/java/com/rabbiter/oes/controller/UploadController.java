...
public class UploadController {
    ...
    private static final String UPLOAD_DIR = "D:\\SystemStorage\\Desktop\\研一课程相关资料\\高级软件工程\\大作业\\workspace\\upload\\"; // 本地存储目录
    ...
    public ResponseEntity<String> handleFileUpload(@RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            // 返回文件的本地存储路径
            return ResponseEntity.ok(saveLocation.getAbsolutePath());
        } catch (IOException e) {
            e.printStackTrace();
